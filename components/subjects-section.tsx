          ...
          {blocks.map((block) => {
            ...
            return (
              <article
                ...
                style={{ borderColor: '#E4DEEF', boxShadow: '0 8px 24px rgba(29,26,43,0.06)' }}
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col">
                    ...
                    <h3 className="font-grotesk text-lg leading-tight sm:text-xl" style={{ color: '#5A3D82' }}>
                      {block.title}
                    </h3>
                  </div>
                </div>
                ...
                <ul className="mt-5 grid grid-cols-1 gap-x-4 gap-y-2 sm:grid-cols-2">
                  {block.items.map((item) => (
                    <li key={item} className="flex items-start gap-2 text-sm" style={{ color: '#24242A' }}>
                      <span
                ...
                <p className="mt-5 border-t pt-4 text-sm leading-relaxed" style={{ color: '#6B6872', borderColor: '#EFEAF6' }}>
                  {block.description}
                </p>
              </article>
            );
